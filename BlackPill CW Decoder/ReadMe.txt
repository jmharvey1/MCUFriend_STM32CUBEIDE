...
Use "F411CWDecoder.bin" and STM's SMT32CubeProgrammer to "flash" the program to your Blackpill MPU. Alternatively compile the scouce code using files found in F411CWDecoder__20221014.zip and STM's STM32CubeIDE (ver 1.9.0). Instructions for both methods can be found in the "Build Docs" folder of this repository.
